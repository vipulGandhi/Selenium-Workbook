// Selenium
	...
	// Selenium interacts only with the elements which are present and visible on the page
...
// Selenium Architecture
	// After the test case is triggered, complete Selenium code (Client) is converted to Json format
